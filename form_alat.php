 ...
 // Insert record
 $query = "INSERT INTO karya_alat(nama,lokasi) VALUES('".$judul."','".$target_file."')";
 mysqli_query($koneksi,$query);
 echo "<script>window.alert('Upload successfully.') ;window.location.href = 'kemahasiswaan?p=f_al';</script>";
 }
 }
 }else{
 ...
 <form method="post" action="" enctype='multipart/form-data'>
                <div class="card-style mb-30">
                  <h6 class="mb-25">Form Unggah Karya Ilmiah - Alat</h6>
